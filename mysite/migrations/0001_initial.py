# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-12 13:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='menu_item', to='mysite.menu_item', verbose_name='\u7236\u8282\u70b9')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='menuitem', to='mysite.menu_item', verbose_name='\u83dc\u5355')),
            ],
        ),
        migrations.CreateModel(
            name='MyModel',
